    ...
    rules: [
      {
        ...
        validator: async (_, value) => {
          ...
          return (
            !cnpj.isValid(value) && Promise.reject(new Error('Cnpj inválido!'))
          )
        }
      }
    ],
...
const formSettingsBranchEdit = formSettingsBranch.map((item) => ({
  ...item,
  show: true
}))
...
export { settingsNextStep, formSettingsBranch, formSettingsBranchEdit }
